...
[![Build Status](https://travis-ci.org/orchestral/model.svg?branch=4.x)](https://travis-ci.org/orchestral/model)
...
[![Coverage Status](https://coveralls.io/repos/github/orchestral/model/badge.svg?branch=4.x)](https://coveralls.io/github/orchestral/model?branch=4.x)
